...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        String file = "/media/hadoopuser/College/College Labs/Big Data Systems/health_data/health_0.json";
        ...
        System.out.println(messages.get(0).getServiceName());
//        messageList = gson.fromJson(builder.toString(), HealthMessages.class);
//        while(true) {
